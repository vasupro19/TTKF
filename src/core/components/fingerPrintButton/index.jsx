...
const FingerprintButton = formik => {
    ...
    const handleAnimationEnd = () => {
        if (isActive) {
            formik.formik.handleSubmit() // Trigger formik submission only after animation
            setIsActive(false) // Reset animation state
        }
    }
    ...
    return (
        <div
            className={`containerBtn ${isActive ? 'active' : ''}`}
            ref={containerRef}
            onClick={handleClick}
