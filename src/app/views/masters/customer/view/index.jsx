...
import { getCustomer } from '@/app/store/slices/api/customerSlice'
...
export default function ViewVendor() {
    ...
    const basicInformationData = [
        { label: 'Customer Name', value: companyData?.name, type: 'text' },
        { label: 'Ref No.', value: companyData?.no, type: 'text' },
        { label: 'Customer Code', value: companyData?.code, type: 'text' },
    ...
    const otherDetailsData = [
        { label: 'Customer Type', value: companyData?.customer_type, type: 'text' },
        { label: 'Customer Group', value: companyData?.customer_group, type: 'text' },
    ...
    useEffect(() => {
        ...
        if (viewID && parseInt(viewID)) getCustomerData(viewID)
    }, [viewID])
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', width: '100%', position: 'relative' }}>
                        ...
                        >
                            ...
                            <UiAccessGuard type='edit'>
                                <Link to={`/master/customer/edit/${viewID}`}>
                                    <IconButton
