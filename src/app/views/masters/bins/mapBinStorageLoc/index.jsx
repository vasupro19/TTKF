...
function MapBinStorageLoc() {
    ...
    const validationSchema = z.object({
        binCode: z.string().nonempty('Bin Code is required'),
    ...
    useEffect(() => {
        if (binInputRef.current && activeTab === 0) {
    ...
    const notes = [
        ...
        {
            id: 'n2',
            text: 'Scan the Bin Code first (required). The scanned value will automatically appear in the first input field.'
        },
        {
            id: 'n3',
            text: 'After scanning the Bin Code, proceed to scan the Location Code (required) in one step.'
        },
        {
            id: 'n4',
        ...
        {
            id: 'n5',
            text: 'Once the form is submitted successfully, the focus will return to the Bin Code input field, indicating readiness for the next scan.'
        },
        {
            id: 'n6',
                        ...
                        {activeTab === 0 ? (
                                            ...
                                            <Grid container spacing={1} alignItems='center'>
                                                <Grid item xs={12} md={6}>
                                                    <CustomFormInput
                                                        ...
                                                        inputProps={{
                                                            ...
                                                            onChange: e => {
                                                                formik.setFieldValue('binCode', e.target.value)
                                                            },
                                                            onBlur: e => {
                                                            ...
                                                            onClick: () => {
                                                                if (isMobile) {
                                                                    binInputRef.current.readOnly = false
                                                                }
                                                            }
                                                        }}
                                                        customSx={{
                                                ...
                                                <Grid item xs={12} md={6}>
                                                    <CustomFormInput
                                                        ...
                                                        disabled={!formik?.values?.binCode}
                                                    />
                                                </Grid>
                                                ...
                                                <Grid item xs={12} sx={{ display: 'flex', justifyContent: 'flex-end' }}>
                                                    <Button
                                                        ...
                                                        color='primary'
                                                        disabled={
                                                            !(formik.values.binCode && formik.values.locationCode)
                                                        }
                                                    >
                                                ...
                                                {modalType === 'confirm_modal' && (
                                                    <ConfirmModal
                                                        ...
                                                        message={`Are you sure you still want to map this bin (#BIN-102)`}
                                                        icon='info'
                                                        confirmText='Yes'
                            ...
                            >
                                <ImportFileModal
                                    ...
                                    sampleFilePath='/csv/master/mapBinStorageLoc.csv'
                                />
                            </Box>
                        )}
                    </Box>
...
export default MapBinStorageLoc
