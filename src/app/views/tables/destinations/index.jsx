...
function MasterDestinationTable() {
    ...
    const queryHandler = async queryString => {
        const { data: response } = await dispatch(getDestinationClients.initiate(queryString, false))
...
export default MasterDestinationTable
